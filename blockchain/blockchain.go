...
func (bc *Blockchain) MineBlock(transactions []*Transaction,gecko []*gecko.Gecko) *Block {
	var lastHash []byte
	var lastHeight int
	...
	newBlock := NewBlock(transactions,gecko, lastHash, lastHeight+1)


	//fmt.Println("breakkkkkkkkkk")
